...
<h3>Tout les utilisateurs supprimer </h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item active">Utilisateurs supprimer</li>
@endsection
...
<div class="container-fluid">
	<div class="row">
        ...
        <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
            ...
            <a style="float: left;" href="/restaurer-user/{{$all->id}}" class="btn btn-warning">Restaurer</a>
            @endif
                <div class="card-body">
