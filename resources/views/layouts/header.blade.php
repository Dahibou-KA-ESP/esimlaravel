    ...
    <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown pe-0 py-0">
          <div class="media profile-media"><img class="b-r-10" style="width:40px;height:40px" src="{{ asset('storage/image/profile_image/'.$user->profile_image_filename) }}" alt="">
          ...
          <ul class="profile-dropdown onhover-show-div">
            <li><a href="{{ url('edit-user/'.$user->id) }}"><i data-feather="user"></i><span>Modifier Profile</span></a></li>
            @auth
              @if(Auth::check() && (Auth::user()->role === 'admin' || Auth::user()->role === 'super'))
                <li><a href="{{ url('admin/user') }}"><i data-feather="user"></i><span>Tout les utilisateurs</span></a></li>
              @endif
            @endauth
            ...
            <li>
                <a class="dropdown-item" href="{{ route('logout') }}"
                                         ...
                                         <i data-feather="log-in"> </i><span>   {{ __('Logout') }}
