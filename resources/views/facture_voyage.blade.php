    ...
    <div class="row align-items-start justify-content-center ">
        <div class="col-md-6 mt-5">          
            <div class="button sticky-top">
                @auth
                <!-- <a class="btn text-white mb-1" href="https://comparateurtest.assurpro.sn/detail-talon-v/{{ $package->id_talon_v}}/{{ $package->id_client }}" style="background-color:#5c1245;width:250px;">Voir détails</a> -->
                    <a class="btn text-white mb-1" href="https://comparateurtest.assurpro.sn/admin/simulation_voyage" style="background-color:#5c1245;width:250px;">Nouvelle simulation</a>
                    @else
                    <a class="btn text-white mb-1" href="http://dev.assurpro.sn/comparateur-voyage" style="background-color:#5c1245;width:250px;">Nouvelle simulation</a>
                @endauth 
        ...
        <div class="col-md-6 bg-dark p-2 pdf2" style="background:#6e6e6e !important; ">
            <div id="pdf"  class="container " style=" background:white;">
                ...
                <div class="invoice" >
                    <div class="row">
                        ...
                        <div class="col-4">
                            @if($package->statut == 1)
                                ...
                                <p class="text-right">Nº: {{$package->n_police_v}}</p>
                            @endif
                            @if($package->statut == 0)
                    ...
                    <div class="col-4">
                        ...
                        <div class="col-4">
                            <p class="addressDriver text-right">
                                <strong >Béneficiaire</strong><br/>
                                <!-- Réf. Client <em th:text="${driver.getUserId()}">Référence client</em><br/> -->
                                <span >{{$package->name}}</span><br/>
                                <span >{{$package->email}}</span><br/>
                                <span >{{$package->contact}}{{$package->client->phone}}</span> <br/>
                                <span>{{$package->adrss}}</span>
                            </p>
                        </div>
                    </div>
                    <!-- <div class="row">
                    ...
                    <h6 >Fait à Dakar le: {{$package->date_etablissement}} <span></span>  
                    </h6>
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>Sénégal</td>
                            <td>{{$package->pays_destination}}</td>
                            <td>{{$package->date_depart}} - {{$package->date_retour}}</td>
                            <td>{{$package->duree}} </td>
                            <!-- <td>14%</td> -->
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td>{{$package->name}}</td>
                            <td>{{$package->age}} An(s)</td>
                            <td>{{$package->n_passport}} </td>
                    ...
                    <div class="row mt-1">
                        <div class="col-8">
                            <p class="conditions" >
                                ...
                                <br/><b> du {{$package->date_depart}} au {{$package->date_retour}} à 23h:59</b> <br/><br/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                        <div class="logo-table mb-2 text-end">
                                <img   style="width:100px;height:auto"src="{{asset('/storage/image/logo/' .$package->compagnie->logo);}}" alt="{{$package->compagnie->abr}}"  class="logo img-fluid2"/>
                            </div> 
                        </div>
...
<script>
    ...
    function SaveToPDF() {
        ...
        var clientN_police = '{{$package->n_police_v}}';
        var options = {
