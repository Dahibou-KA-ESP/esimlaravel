...
<p>Retrouver votre facture en cliquant <a href="{{env('APP_URL')}}/facture_client_v/{{$id_client}}/{{$id_talon_v}}">ici</a>  </p>
<p>Votre attestation sera livrée sous 24h ouvrées</p>
