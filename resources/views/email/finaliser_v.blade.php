...
<p>Nous avons remarqués que votre souscription pour une assurance voyage auprès de Platine assurances n'est pas arrivé à terme.</p>
<p>Vous pouvez la finalisé: <a href="{{env('APP_URL')}}/facture-voyage/{{$id_client}}/{{$id_talon_v}}">ici</a> </p>
