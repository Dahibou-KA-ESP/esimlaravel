<p>Bonjour {{$nom}},</p>
<p>Votre mot de passe de connexion a ete redefini par {{$password}}.Veuillez le changer a votre connexion merci!</p>
<p>Vous pouvez vous connectez ici: {{env('APP_URL')}}/login </p>
