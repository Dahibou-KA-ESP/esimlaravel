...
// Restricted column ordering
    ...
    $('#liste-echeance-cours').DataTable( {
        dom: 'Bfrtip',
        buttons: [
            // 'copyHtml5',
            'excelHtml5',
    ...
    $('#liste-client-non-livre').DataTable( {
        dom: 'Bfrtip',
        buttons: [
            // 'copyHtml5',
            'excelHtml5',
    ...
    $('#liste-souscription-v').DataTable( {
        dom: 'Bfrtip',
        buttons: [
            // 'copyHtml5',
            'excelHtml5',
...
// new $.fn.dataTable.Responsive( table );
    ...
    $('#pagelength-btn').DataTable( {
        ...
        lengthMenu: [
            [ 10, 25, 50, -1 ],
            [ '10 lignes', '25 lignes', '50 lignes', 'voir tout' ]
        ],
        buttons: [
            'pageLength'
        ]
