...
var entreprise_form = document.querySelectorAll(".entreprise-form");
let formnumber = 0;
...
function updateform() {
    ...
    entreprise_form.forEach(function (content) {
        content.classList.remove('active');
        var entrepriseType = document.querySelector(".entreprise-type");
        switch (entrepriseType.value) {
            case 'legal_entity':
