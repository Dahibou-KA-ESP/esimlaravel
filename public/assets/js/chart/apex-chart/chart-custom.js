...
// area spaline chart
$.ajax({
    url: '/getSimulationsAndSubscriptionsData',
    method: 'GET',
        ...
        var seriesData = [
            {
              ...
              data: data.souscriptionsData // Utilisez les données de souscriptions reçues du serveur
            }
          ];
      
          // Si vous voulez ajouter plus tard une série comme "Simulations auto", vous pouvez le faire comme ceci:
          // Décommenter cette partie pour ajouter dynamiquement la série "Simulations auto"
          /*
          seriesData.push({
            name: 'Simulations auto',
            data: data.simulationsData // Utilisez les données de simulations reçues du serveur
          });
          */
        var options1 = {
            chart: {
            ...
            series: [{
                name: "Assurances auto",
                data: data.souscriptionsData // Utilisez les données de simulations reçues du serveur
            }, 
            {
                name: 'Simulations auto',
                data: data.simulationsData // Utilisez les données de souscriptions reçues du serveur
            },
            //  {
            //     name: 'Asssurances Voyage',
            //     data: data.souscriptionsDataV, // Utilisez les données de souscriptions reçues du serveur
            //     color: '#5c1245'
            // }
        ],
            xaxis: {
                type: 'datetime',
                categories: data.jours // Utilisez les catégories de dates reçues du serveur
            },
...
$.ajax({
    ...
    method: 'GET',
        ...
        var options1 = {
            ...
            // }, 
            {
                name: 'Simulations Voyage',
                data: data.simulationsDataV // Utilisez les données de souscriptions reçues du serveur
            },
             {
                name: 'Asssurances Voyage',
                data: data.souscriptionsDataV, // Utilisez les données de souscriptions reçues du serveur
...
// area spaline chart1
$.ajax({
    url: '/getSimulationsAndSubscriptionsDataPart',
    method: 'GET',
        success: function (data) {
        // console.log('Réponse du serveur :', data);
        var options1 = {
...
var options3 = {
    ...
    xaxis: {
        categories: ['Jan','fevr', 'Mar', 'Avr', 'Mai', 'Juin', 'Jul', 'Aout', 'Sept', 'Oct','Nov',],
    },
    yaxis: {
        title: {
            text: 'Nbrs Talons'
